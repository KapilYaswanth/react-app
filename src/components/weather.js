  ...
  constructor(props)
  {
    ...
    search = async (e) => {
        e.preventDefault();
            ...
            const data = await fetchweather(this.state.query).catch(this.setState({query:''}));
            console.log(data);
  ...
  render() {
    return(<div className="container">
        ...
        <form  onSubmit={this.search}>
            <input type="text" className="task-input" placeholder="Search for a place" autoFocus required value={this.state.query} onChange={(e) => this.setState({query:e.target.value})}/>
